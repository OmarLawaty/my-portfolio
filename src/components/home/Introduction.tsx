    ...
    <Flex as='section' w='full' gap='24' align='center' justify='space-between' h='fit'>
      <Flex flexDir='column' gap='1'>
        ...
        <Text mt='2' color='gray.3d00' fontWeight='300' fontSize='1rem' maxW='38rem'>
          ...
          strong focus on performance and clean UI. I&apos;m currently open to remote internships or part-time roles
          where I can grow and contribute to meaningful projects.
        </Text>
